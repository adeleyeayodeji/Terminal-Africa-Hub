    ...
    switch (linkText) {
      case "Get Quotes":
        ...
        links.each(function (index, element) {
          //parse the href
          $(this).attr("href", `https://${siteType}.${currentSiteDomain}/quotes`);
        });
        break;
      case "Book Shipment":
        ...
        links.each(function (index, element) {
          //parse the href
          $(this).attr("href", `https://${siteType}.${currentSiteDomain}/shipments/book`);
        });
        break;
      case "Track Shipment":
        ...
        links.each(function (index, element) {
          //parse the href
          $(this).attr("href", `https://${siteType}.${currentSiteDomain}/track`);
        });
        break;
      case "Track Package":
        //https://app.thepep.africa/track
      ...
      case "Send Cargo":
        ...
        links.each(function (index, element) {
          //parse the href
          $(this).attr("href", `https://${siteType}.${currentSiteDomain}/shipments/book-cargo`);
        });
        break;
      case "Send Express":
        //https://app.thepep.africa/book
      ...
      case "Login":
        ...
        links.each(function (index, element) {
          $(this).attr("href", `https://${siteType}.${currentSiteDomain}/auth/login`);
        });
        break;
      case "Sign Up":
